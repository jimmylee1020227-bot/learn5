  ...
  return (
    <nav
      style={{
        ...
        right: 0,
        height: '62px',
        backgroundColor: 'var(--theme-card, var(--theme-card, #fffdf9))',
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          padding: '5px 8px',
          cursor: 'pointer',
          color: activeTab === 'quiz' ? 'var(--theme-accent, var(--theme-accent, #ef8354))' : '#5b6772',
          flex: 1,
          maxWidth: '68px',
      ...
      <button
        ...
        style={{
          ...
          padding: '5px 8px',
          cursor: 'pointer',
          color: activeTab === 'reinforce' ? 'var(--theme-accent, var(--theme-accent, #ef8354))' : '#5b6772',
          flex: 1,
          maxWidth: '68px',
          transition: 'all 0.15s ease'
        }}
      ...
      <button
        ...
        style={{
          ...
          padding: '5px 8px',
          cursor: 'pointer',
          color: activeTab === 'leaderboard' ? 'var(--theme-accent, var(--theme-accent, #ef8354))' : '#5b6772',
          flex: 1,
          maxWidth: '68px',
          transition: 'all 0.15s ease'
        }}
