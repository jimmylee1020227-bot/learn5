      ...
      >
        ...
        >
          ...
          >
            ...
            歡迎使用「<strong>學習網</strong>」（以下簡稱本平台）。本平台為專為台灣國中會考與高中升學打造之免費無廣告教育公益平台。為了讓您能在手機、平板與電腦跨設備隨時複習、無縫同步答題歷程、錯題本與每週排行競技，本平台需要存取並處理必要的學習與帳號資料。請詳細閱讀以下由本程式實際運作涉及之所有個人資料處理項目：
          </div>
