...
export function generateMathQuestion(gradeId, unitId, index, difficulty = 'medium', rand, conceptTag) {
    ...
    if (uNum === 3) {
      if (isExtreme) {
        ...
        return {
          ...
          answer: 0,
          hint: `💡 提示：質因數分解：12 = 2² \\\\times 3，18 = 2 \\\\times $3^2$。`,
          explanation: `📖 詳解：最大公因數 (12, 18) = 2 \\\\times 3 = 6；最小公倍數 [12, 18] = 2² \\\\times $3^2$ = 36。`
        };
      }
    }
    ...
    if (uNum === 6) {
      if (isExtreme) {
        return {
          ...
          options: [`24`, `48`, `12`, `36`],
          answer: 0,
          hint: `💡 提示：令 y=0 求 A 點 x 截距；令 x=0 求 B 點 y 截距。直角三角形面積 = 底 \\\\times 高 \\\\div 2。`,
          explanation: `📖 詳解：令 y=0 得 4x=24 ⇒ A(6, 0)；令 x=0 得 3y=24 ⇒ B(0, 8)。$\\\\triangle OAB$ 面積 = 6 \\\\times 8 \\\\div 2 = 24。`
        };
      } else {
        return {
    ...
    if (uNum === 7) {
      if (isExtreme) {
        return {
          ...
          explanation: `📖 詳解：-9 $\\\\le$ 2x - 5 $\\\\le$ 9 ⇒ -4 $\\\\le$ 2x $\\\\le$ 14 ⇒ -2 $\\\\le$ x $\\\\le$ 7。整數 x 有 -2, -1, 0, 1, 2, 3, 4, 5, 6, 7 共 10 個。`
        };
      } else {
        return {
  ...
  if (gradeId === 'g8') {
    ...
    if (uNum === 1) {
      if (isExtreme) {
        return {
          question: `【奧林匹亞/IMC競賽-乘法公式變形】${preamble}\n已知實數 x 滿足 \`x + ¹/ₓ = 4\`，請問 \`$x^3 + \\\\frac{1}{x^3}$\` 的值為何？`,
          options: [`52`, `64`, `48`, `56`],
          answer: 0,
          hint: `💡 提示：利用立方和展開式：(x + ¹/ₓ)³ = $x^3 + \\\\frac{1}{x^3}$ + 3(x + ¹/ₓ)。`,
          explanation: `📖 詳解：(x + ¹/ₓ)³ = 4³ = 64。64 = $x^3 + \\\\frac{1}{x^3}$ + 3(4) ⇒ $x^3 + \\\\frac{1}{x^3}$ = 64 - 12 = 52。`
        };
      } else {
        return {
          ...
          explanation: `📖 詳解：(100 + 3)(100 - 3) = 100² - $3^2$ = 10000 - 9 = 9991。`
        };
      }
    }
    ...
    if (uNum === 2) {
      if (isExtreme) {
        ...
        return {
          ...
          answer: 0,
          hint: `💡 提示：畢氏定理 $a^2$ + $b^2$ = $c^2$，5² + 12² = 25 + 144 = 169。`,
    ...
    if (uNum === 4) {
      if (isExtreme) {
        return {
          question: `【私中/競賽-韋達定理求值】${preamble}\n若方程式 \`$x^2 - 6x + 2 = 0$\` 的兩根為 α 與 β，則 \`$\\\\alpha^2$ + $\\\\beta^2$\` 的值為多少？`,
          options: [`32`, `36`, `38`, `34`],
          answer: 0,
          hint: `💡 提示：韋達定理：α + β = 6，αβ = 2。$\\\\alpha^2$ + $\\\\beta^2$ = (α + β)² - 2αβ。`,
          explanation: `📖 詳解：$\\\\alpha^2$ + $\\\\beta^2$ = 6² - 2(2) = 36 - 4 = 32。`
        };
      } else {
        return {
          question: `【一元二次方程式解法】${preamble}\n方程式 \`(x - 3)(2x + 5) = 0\` 的兩根為何？`,
          options: [`x = 3 或 $-\\\\frac{5}{2}$`, `x = -3 或 $\\\\frac{5}{2}$`, `x = 3 或 $\\\\frac{5}{2}$`, `x = -3 或 $-\\\\frac{5}{2}$`],
          answer: 0,
          hint: `💡 提示：若 A \\\\times B = 0，則 A = 0 或 B = 0。`,
          explanation: `📖 詳解：x - 3 = 0 ⇒ x = 3；2x + 5 = 0 ⇒ x = $-\\\\frac{5}{2}$。`
        };
      }
    }
    ...
    if (uNum === 5) {
      if (isExtreme) {
        return {
          ...
          answer: 0,
          hint: `💡 提示：求 $a_n$ $\\\\ge$ 0 的最後一項：41 + (n-1)(-3) $\\\\ge$ 0 ⇒ n $\\\\le$ 14.66。`,
          explanation: `📖 詳解：第 14 項 $a_1$₄ = 41 + 13(-3) = 2 > 0；第 15 項 $a_1$₅ = -1 < 0。故 n=14 時和最大：S₁₄ = $\\\\frac{14(41 + 2)}{2}$ = 301... 梯形公式計算為 294。`
        };
      } else {
        return {
          ...
          answer: 0,
          hint: `💡 提示：$a_n$ = $a_1$ + (n-1)d ⇒ 45 = 5 + (n-1)×4。`,
    ...
    if (uNum === 6) {
      if (isExtreme) {
        return {
          question: `【幾何競賽-折線平行截角性質】${preamble}\n如圖，若 L₁ // L₂，且在兩平行線間折線構成多個夾角，已知 $\\\\angle 1 = 35^\\\\circ$，$\\\\angle 2 = 80^\\\\circ$，$\\\\angle 3 = 40^\\\\circ$，則尖端朝右之未知角 $\\\\theta$ 為多少度？`,
          options: [`75°`, `85°`, `65°`, `70°`],
          answer: 0,
          hint: `💡 提示：過折點作平行輔助線，向左開口的角度和等於向右開口的角度和（鋸齒角定理）。`,
          explanation: `📖 詳解：根據平行線鋸齒截角定理：向左之角和等於向右之角和，可解得 $\\\\theta$ = 75°。`
        };
      } else {
        return {
    ...
    if (uNum === 1) {
      if (isExtreme) {
        return {
          ...
          explanation: `📖 詳解：$\\\\triangle ADE$ 與 $\\\\triangle ABC$ 相似，面積比 = 2² : 5² = 4 : 25。四邊形 DBCE 面積佔 25 - 4 = 21 份。每份為 42 \\\\div 21 = 2。故 $\\\\triangle ADE$ 面積 = 4 \\\\times 2 = 8。`
        };
      } else {
        return {
          ...
          explanation: `📖 詳解：4 : 6 = 6 : EC ⇒ 4 \\\\times EC = 36 ⇒ EC = 9。`
        };
      }
    }
    ...
    if (uNum === 2) {
      if (isExtreme) {
        return {
          ...
          options: [`5`, `9`, `6`, `4`],
          answer: 0,
          hint: `💡 提示：切割線定理 PT² = PA \\\\times PB ⇒ 6² = 4 \\\\times PB。`,
          explanation: `📖 詳解：36 = 4 \\\\times PB ⇒ PB = 9。弦長 AB = PB - PA = 9 - 4 = 5。`
        };
      } else {
        return {
          ...
          explanation: `📖 詳解：圓心角度數 = 2 \\\\times 圓周角 = 2 \\\\times $40^\\\\circ$ = $80^\\\\circ$。`
        };
      }
    }
    ...
    if (uNum === 3) {
      if (isExtreme) {
        return {
          ...
          explanation: `📖 詳解：斜邊 AB = $\\\\sqrt{6^2 + 8^2}$ = 10。直角三角形斜邊中線 CM = 10 / 2 = 5。重心性質 CG : GM = 2 : 1，故 CG = 5 \\\\times ($\\\\frac{2}{3}$) = $\\\\frac{10}{3}$。`
        };
      } else {
        return {
    ...
    if (uNum === 5) {
      if (isExtreme) {
        return {
          ...
          options: [`$\\\\frac{13}{28}$`, `$\\\\frac{15}{28}$`, `$\\\\frac{1}{2}$`, `1$\\\\frac{1}{2}$8`],
          answer: 0,
          hint: `💡 提示：兩紅機率 ($\\\\frac{5}{8}$ \\\\times $\\\\frac{4}{7}$) + 兩白機率 ($\\\\frac{3}{8}$ \\\\times $\\\\frac{2}{7}$)。`,
          explanation: `📖 詳解：兩紅 = (5×4)/(8×7) = $\\\\frac{20}{56}$；兩白 = (3×2)/(8×7) = $\\\\frac{6}{56}$。同色機率 = 2$\\\\frac{6}{56}$ = $\\\\frac{13}{28}$。`
        };
      } else {
        return {
          question: `【古典機率基本計算】${preamble}\n同時擲兩顆公正的六面骰子，出現點數和為 7 的機率為多少？`,
          options: [`$\\\\frac{1}{6}$`, `$\\\\frac{1}{12}$`, `$\\\\frac{7}{36}$`, `$\\\\frac{5}{3}$6`],
          answer: 0,
  ...
  if (gradeId === 'past-exams') {
    if (uNum === 1) {
      return {
        ...
        answer: 0,
        hint: `💡 提示：兩股為 a、b。a+b-c = 2r ⇒ a+b-25 = 8 ⇒ a+b = 33。周長 = a+b+c = 58。面積 = r \\\\times 周長 \\\\div 2 = 4 \\\\times 58 \\\\div 2 = 116。`,
        explanation: `📖 詳解：利用公式 r = (a + b - c)/2 得 a + b = 25 + 8 = 33。周長 = 33 + 25 = 58。直角三角形面積 = r \\\\times s = 4 \\\\times ($\\\\frac{58}{2}$) = 116。`
      };
    } else {
      return {
        isReading: true,
  ...
  if (gradeId === 'private-school') {
    if (uNum === 1) {
      return {
        ...
        answer: 0,
        hint: `💡 提示：(p - q)(p + q) = 77 = 7 \\\\times 11。p+q=11, p-q=7 ⇒ 2p = 18 ⇒ p = 9 (9 不是質數！)`,
      ...
      return {
        ...
        answer: 0,
        hint: `💡 提示：外接圓直徑有 12/2 = 6 條。每條直徑對應其餘 10 個頂點皆構成圓周角 $90^\\\\circ$ 的直角三角形。`,
